...
import (
	"context"
	"github/wangguoyan/multicluster-controller/pkg/handler"
...
type Cluster interface {
	...
	AddEventHandler(context.Context, client.Object, cache.ResourceEventHandler) error
	manager.Cache
}
...
func (c *Controller) WatchResourceReconcileObject(ctx context.Context, cluster Cluster, objectType client.Object, o WatchOptions) error {
	h := &handler.EnqueueRequestForObject{Context: cluster.GetClusterName(), Queue: c.Queue, Filter: o.Filter, Predicates: o.Predicates}
...
func (c *Controller) WatchResourceReconcileObjectOverrideContext(ctx context.Context, cluster Cluster, objectType client.Object, o WatchOptions, contextOverride string) error {
	h := &handler.EnqueueRequestForObject{Context: contextOverride, Queue: c.Queue, Filter: o.Filter, Predicates: o.Predicates}
	return c.WatchResource(ctx, cluster, objectType, h)
}
...
func (c *Controller) WatchResourceReconcileController(ctx context.Context, cluster Cluster, objectType client.Object, o WatchOptions) error {
	h := &handler.EnqueueRequestForController{Context: cluster.GetClusterName(), Queue: c.Queue, Predicate: o.Filter}
	return c.WatchResource(ctx, cluster, objectType, h)
}
...
func (c *Controller) WatchResource(ctx context.Context, cluster Cluster, objectType client.Object, h cache.ResourceEventHandler) error {
